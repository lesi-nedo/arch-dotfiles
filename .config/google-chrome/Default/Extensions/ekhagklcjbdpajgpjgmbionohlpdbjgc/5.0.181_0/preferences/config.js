...
Zotero_Preferences_Config.Row = class Row extends React.Component {
  ...
  render() {
    ...
    }, React.createElement("td", null, this.props.name), React.createElement("td", {
      className: isNotDefault ? 'is-not-default' : ''
    }, this.state.value), React.createElement("td", null, React.createElement("a", {
      href: "javascript:void(0);",
