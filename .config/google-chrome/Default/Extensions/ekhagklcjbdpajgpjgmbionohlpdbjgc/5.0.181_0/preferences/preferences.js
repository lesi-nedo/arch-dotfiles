  ...
  init: async function () {
    ...
    Zotero.Prefs.loadNamespace('shortcuts').then(function () {
      ...
      for (let span of spans) {
        ReactDOM.render(React.createElement(Zotero_Preferences.Components.ShortcutInput, {
          pref: span.dataset.pref
        }), span);
      }
    });
...
Zotero_Preferences.Components.ClientStatus = class ClientStatus extends React.Component {
  ...
  render() {
    let available = React.createElement("span", null, "available.");
    if (!this.state.available) {
      available = React.createElement("span", null, "unavailable. If Zotero is open, see the ", React.createElement("a", {
        href: "https://www.zotero.org/support/kb/connector_zotero_unavailable"
      }, "troubleshooting page"), ".");
    }
    return React.createElement("div", null, React.createElement("p", null, "Zotero is currently ", available), React.createElement("p", null, React.createElement("input", {
      type: "button",
      value: "Update Status",
...
Zotero_Preferences.Components.ProxySettings = class ProxySettings extends React.Component {
  ...
  render() {
    ...
    }, "Proxy Settings"), React.createElement("div", {
      className: "group-content"
    }, React.createElement("p", null, "Zotero will transparently redirect requests through saved proxies. See the ", React.createElement("a", {
      href: "https://www.zotero.org/support/connector_preferences#proxies"
    }, "proxy documentation"), " for more information."), React.createElement("p", null), React.createElement(Zotero_Preferences.Components.ProxyPreferences, {
      onTransparentChange: this.handleTransparentChange
    }))), React.createElement("div", {
      className: "group"
    }, React.createElement("div", {
      className: "group-title"
    }, "Configured Proxies"), React.createElement("div", {
      className: "group-content"
...
Zotero_Preferences.Components.ProxyPreferences = (_temp = class ProxyPreferences extends React.Component {
  ...
  render() {
    let autoRecognise = '';
    if (Zotero.isBrowserExt) {
      autoRecognise = React.createElement("label", null, React.createElement("input", {
        type: "checkbox",
    ...
    if (this.state.loopPreventionTimestamp > Date.now() && this.state.transparent) {
      redirectLoopPrevention = React.createElement("div", {
        className: "group"
      }, React.createElement("b", null, "Zotero detected a proxy redirect loop and has temporarily suspended automatic proxy redirection."), " ", React.createElement("input", {
        type: "button",
        onClick: this.reenableProxyRedirection,
        value: "Reenable proxy redirection"
      }));
    }
    ...
    }), "\xA0Enable proxy redirection"), React.createElement("div", {
      style: {
        marginLeft: "1em"
      }
    ...
    }), "\xA0Show a notification when redirecting through a proxy"), autoRecognise, React.createElement("p", null, React.createElement("label", null, React.createElement("input", {
      type: "checkbox",
      disabled: !this.state.transparent,
      onChange: this.handleCheckboxChange,
      name: "disableByDomain",
      defaultChecked: this.state.disableByDomain
    }), "\xA0Disable proxy redirection when my domain name contains", React.createElement("span", null, "*")), React.createElement("input", {
      style: {
        marginTop: "0.5em",
        marginLeft: "1.5em"
      },
    ...
    }))), React.createElement("p", null, React.createElement("span", null, "*"), "Available when Zotero is running")));
  }
}, _temp);
Zotero_Preferences.Components.Proxies = class Proxies extends React.PureComponent {
  ...
  renderProxySettings() {
    ...
    return React.createElement("div", {
      ...
      style: {
        visibility: multiHost ? null : 'hidden'
      }
    }, React.createElement("input", {
      type: "checkbox",
      name: "autoAssociate",
      onChange: this.handleCheckboxChange,
      checked: currentProxy.autoAssociate
    }), "\xA0Automatically associate new hosts")), React.createElement("p", {
      style: {
        display: "flex",
        alignItems: "center"
      }
    ...
    }, "Login URL Scheme: "), React.createElement("input", {
      style: {
        flexGrow: "1"
      },
      type: "text",
      ...
      value: currentProxy.toProxyScheme || "",
      ref: "toProxyInput"
    })), React.createElement("p", {
      style: {
        display: "flex",
    ...
    }, "Proxied URL Scheme: "), React.createElement("input", {
      style: {
        flexGrow: "1"
      },
      type: "text",
      name: "toProperScheme",
      onChange: this.handleSchemeChange,
      value: currentProxy.toProperScheme,
      ref: "toProperInput"
    })), React.createElement("p", null, "You may use the following variables in your proxy schemes:", React.createElement("br", null), "%h - The hostname of the proxied site (e.g., www.example.com)", React.createElement("br", null), "%p - The path of the proxied page excluding the leading slash (e.g., about/index.html)", React.createElement("br", null), "%u - Full encoded proxied site url (e.g. https://www.example.com/about/index.html)"), React.createElement("div", {
      style: {
        display: "flex",
        flexDirection: "column",
        marginTop: "10px"
      }
    }, React.createElement("label", null, "Hostnames"), React.createElement("select", {
      className: "Preferences-Proxies-hostSelect",
      size: "8",
      multiple: true,
      value: [this.state.currentHostIdx],
      onChange: this.handleHostSelectChange
    }, currentProxy.hosts.map((host, i) => React.createElement("option", {
      key: i,
      value: i
      ...
      type: "button",
      onClick: this.handleHostButtonClick,
      value: "+"
    }), React.createElement("input", {
      style: {
        minWidth: "80px",
    ...
    }, "Hostname: "), React.createElement("input", {
      style: {
        flexGrow: '1'
      },
      type: "text",
  ...
  render() {
    return React.createElement("div", {
      ...
      style: {
        display: this.props.transparent ? null : 'none'
      }
    }, React.createElement("input", {
      style: {
        minWidth: "80px",
      ...
      type: "button",
      onClick: this.handleProxyButtonClick,
      value: "+"
    }), React.createElement("input", {
      style: {
        minWidth: "80px",
      ...
      type: "button",
      onClick: this.handleProxyButtonClick,
      disabled: !this.state.currentProxy,
      value: "-"
...
Zotero_Preferences.Components.MIMETypeHandling = class MIMETypeHandling extends React.Component {
  ...
  render() {
    ...
    return React.createElement("div", null, React.createElement("p", null, "Available when Zotero is running"), React.createElement("p", null, React.createElement("label", null, React.createElement("input", {
      type: "checkbox",
      onChange: this.handleCheckboxChange,
      name: "enabled",
      defaultChecked: this.state.enabled
    }), "\xA0Import BibTeX/RIS/Refer files into Zotero")), React.createElement("div", {
      style: {
        display: this.state.enabled ? 'flex' : 'none',
        flexDirection: "column",
        marginTop: "10px"
      }
    }, React.createElement("label", null, "Enabled Hostnames"), React.createElement("select", {
...
Zotero_Preferences.Components.ShortcutInput = class extends React.Component {
  constructor(props) {
    ...
    this.state = {
      modifiers: Zotero.Prefs.get(props.pref) || {}
    };
  }
