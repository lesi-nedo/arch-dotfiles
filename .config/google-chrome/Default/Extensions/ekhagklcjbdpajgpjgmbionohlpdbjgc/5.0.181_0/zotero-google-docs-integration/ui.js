...
(function () {
  ...
  const TEXT_INPUT_SELECTORS = ['.docs-link-insertlinkbubble-text', '.docs-link-smartinsertlinkbubble-text', '.appsElementsLinkInsertionLinkTextInput input'];
  const URL_INPUT_SELECTORS = ['.docs-link-urlinput-url', '.docs-link-searchinput-search', '.appsElementsLinkInsertionLinkSearchInput input'];
  ...
  Zotero.GoogleDocs.UI = {
    ...
    injectIntoDOM: async function () {
      ...
      Zotero.GoogleDocs.UI.menu = React.createElement(Zotero.GoogleDocs.UI.Menu, {
        execCommand: Zotero.GoogleDocs.execCommand
      });
      ...
      Zotero.GoogleDocs.UI.citationEditor = React.createElement(Zotero.GoogleDocs.UI.LinkbubbleOverride, {
      ...
      ReactDOM.render(React.createElement(Zotero.GoogleDocs.UI.PleaseWait, {
        ref: ref => Zotero.GoogleDocs.UI.pleaseWaitScreen = ref
      ...
      document.querySelector('.docs-titlebar-buttons').insertBefore(Zotero.GoogleDocs.UI.orphanedCitationsContainer, document.querySelector('#docs-titlebar-share-client-button'));
      ReactDOM.render(React.createElement(Zotero.GoogleDocs.UI.OrphanedCitations, {
    ...
    interceptDownloads: async function () {
      ...
      for (let elem of downloadMenuItems) {
        ...
        elem.addEventListener('mouseup', async function (event) {
          if (!Zotero.GoogleDocs.hasZoteroCitations || Zotero.GoogleDocs.downloadInterceptBlocked) return;
      ...
      pasteTarget.addEventListener('paste', async e => {
        ...
        for (let i = 0; i < links.length; i++) {
          if (links[i] && links[i].lnks_link && links[i].lnks_link.ulnk_url.startsWith(Zotero.GoogleDocs.config.fieldURL)) {
            ...
            .filter(key => !ignoreKeys.has(key) && key in keysToCodes).map(key => keysToCodes[key]);
        ...
        try {
          ...
          if (Zotero.GoogleDocs.Client.isV2) {
            try {
              ...
              Zotero.logError(e);
              let response = await Zotero.GoogleDocs_API.run({
                docID,
                tabId
              }, 'addPastedRanges', [linksToRanges]);
    ...
    initModeMonitor: async function () {
      await new Promise(function (resolve) {
        ...
        observer.observe(document.querySelector('#docs-toolbar-mode-switcher'), {
          attributes: true
        });
      });
      ...
      this.modeObserver.observe(document.querySelector('#docs-toolbar-mode-switcher'), {
        attributes: true
      });
    ...
    toggleEnabled: function (state) {
      ...
      if (!state) {
        ...
        this._menubuttonHoverRemoveObserver.observe(this.menubutton, {
          attributes: true
        });
        ...
        this._buttonHoverRemoveObserver.observe(this.button, {
          attributes: true
        });
    ...
    selectText: async function (text, url = null) {
      ...
      var openFindDialogKbEvent = {
        ctrlKey: true,
        key: 'f',
        keyCode: '70'
      };
      if (Zotero.isMac) {
        openFindDialogKbEvent = {
          metaKey: true,
          key: 'f',
          keyCode: '70'
        };
    ...
    insertFootnote: async function () {
      ...
      if (!Zotero.isMac) {
        await Zotero.GoogleDocs.UI.sendKeyboardEvent({
          key: "Backspace",
          keyCode: 8
        });
      }
    ...
    getSelectedLink: function () {
      ...
      if (!elem) return "";else return elem.getAttribute('href');
    },
    moveCursorToEndOfCitation: async function () {
      ...
      if (selectedText.length) {
        textEventTarget.dispatchEvent(new KeyboardEvent('keydown', {
          key: "ArrowRight",
          keyCode: 39
        }));
      }
    ...
    setupWaitForSave: function () {
      ...
      this.docSyncedPromise = Promise.any([Zotero.Promise.delay(SYNC_TIMEOUT), new Promise(resolve => {
        ...
        observer.observe(saveIndicator, {
          childList: true,
          subtree: true
        });
      })]);
  ...
  Zotero.GoogleDocs.UI.LinkInsertBubble = {
    ...
    init() {
      ...
      if (!this._linkInsertBubble) {
        ...
        this._linkInsertBubblePromise = new Promise(resolve => {
          ...
          observer.observe(Zotero.GoogleDocs.UI._getElemBySelectors('.kix-appview-editor'), {
            childList: true
          });
        });
      } else {
    ...
    async waitToOpenAndMakeInvisible() {
      ...
      await new Promise(resolve => {
        ...
        observer.observe(linkInsertBubble, {
          attributeFilter: ["style", 'subtree', 'childList', 'attributes']
        });
    ...
    async close(confirm = true) {
      ...
      if (confirm && urlInput.value) {
        ...
        if (urlInput.value) {
          textEventTarget.contentDocument.dispatchEvent(new KeyboardEvent('keydown', {
            key: "ArrowRight",
            keyCode: 39
          }));
        }
  ...
  Zotero.GoogleDocs.UI.Menu = class extends React.Component {
    ...
    componentDidMount() {
      this.observer = new MutationObserver(async function (mutations) {
        for (let mutation of mutations) {
          ...
          this.setState({
            open,
            displayAddAnnotationButton,
            displayCitationExplorerOption,
            highlightedItem: -1
          });
        }
      }.bind(this));
      this.observer.observe(Zotero.GoogleDocs.UI.menubutton, {
        attributes: true
      });
    ...
    render() {
      ...
      this._items = [React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
        label: "Add/edit citation...",
        shortcutKey: "c",
        activate: this.props.execCommand.bind(this, 'addEditCitation', null),
        accel: Zotero.GoogleDocs.UI.shortcut
      })];
      if (this.state.displayAddAnnotationButton) {
        this._items.push(React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
          label: "Add annotation...",
          shortcutKey: "a",
          activate: this.props.execCommand.bind(this, 'addAnnotation', null)
        }));
      }
      this._items.push(React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
        label: "Add note...",
        shortcutKey: "n",
        activate: this.props.execCommand.bind(this, 'addNote', null)
      }), React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
        label: "Add/edit bibliography",
        shortcutKey: "b",
        activate: this.props.execCommand.bind(this, 'addEditBibliography', null)
      }));
      if (this.state.displayCitationExplorerOption) {
        this._items.push(React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
          label: "Citation explorer...",
          shortcutKey: "e",
          activate: this.props.execCommand.bind(this, 'citationExplorer', null)
        }));
      }
      this._items.push(React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
        label: "Document preferences...",
        shortcutKey: "p",
        activate: this.props.execCommand.bind(this, 'setDocPrefs', null)
      }), React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
        label: "Refresh",
        shortcutKey: "r",
        activate: this.props.execCommand.bind(this, 'refresh', null)
      }), React.createElement(Zotero.GoogleDocs.UI.Menu.Item, {
        ...
        label: "Unlink citations...",
        shortcutKey: "u",
        activate: this.props.execCommand.bind(this, 'removeCodes', null)
      }));
      ...
      return React.createElement("div", {
        id: "docs-zotero-menu",
        className: "goog-menu goog-menu-vertical docs-menu-hide-mnemonics",
        role: "menu",
        style: style
      }, this._items);
    }
  ...
  Zotero.GoogleDocs.UI.Menu.Item = class extends React.Component {
    ...
    render() {
      ...
      if (this.props.shortcutKey && shortcutIdx != -1) {
        ...
        }, label.substring(0, shortcutIdx), React.createElement("u", null, label[shortcutIdx]), label.substring(shortcutIdx + 1));
      } else {
        label = React.createElement("span", {
          className: "goog-menuitem-label"
        }, label);
      ...
      return React.createElement("div", {
        ...
        onMouseEnter: this.toggleHighlight.bind(this, true),
        onMouseLeave: this.toggleHighlight.bind(this, false),
        className: className,
        role: "menuitem",
        id: `:z${this.props.idx}`
      }, React.createElement("div", {
        className: "goog-menuitem-content"
      }, label, this.props.accel ? React.createElement("span", {
  ...
  Zotero.GoogleDocs.UI.LinkbubbleOverride = class extends React.Component {
    ...
    async componentDidMount() {
      ...
      this.observer.observe(this.linkbubble, {
        attributes: true,
    ...
    waitForLinkbubble() {
      return new Promise(function (resolve) {
        var linkbubble = document.querySelector('.docs-bubble.appsElementsLinkPreview') || document.querySelector('#docs-link-bubble');
        ...
        observer.observe(document.getElementsByClassName('kix-appview-editor')[0], {
          childList: true
        });
      });
    }
    render() {
      ...
      var style = {
        left: this.linkbubble.style.left,
        top
      };
      ...
      return React.createElement("div", {
        className: "docs-bubble docs-linkbubble-bubble docs-linkbubble-link-preview",
        role: "dialog",
        style: style
      }, React.createElement("div", {
        className: "link-bubble-header"
      }, React.createElement("div", {
        className: "docs-link-bubble-mime-icon goog-inline-block docs-material"
      }, React.createElement("div", {
        className: "docs-icon goog-inline-block "
      }, React.createElement("div", {
        style: {
      ...
      }, "Edit with Zotero"), React.createElement("span", {
        style: {
          color: '#777',
          textDecoration: 'none',
          marginRight: '6px'
  ...
  Zotero.GoogleDocs.UI.PleaseWait = class extends React.Component {
    ...
    render() {
      ...
      }, Zotero.getString('integration_googleDocs_updating', ZOTERO_CONFIG.CLIENT_NAME), React.createElement("br", null), Zotero.getString('general_pleaseWait')));
    }
  };
  Zotero.GoogleDocs.UI.OrphanedCitations = React.forwardRef(function (props, ref) {
    ...
    }))), React.createElement(Zotero.GoogleDocs.UI.OrphanedCitationsList, {
      citations: citations,
      open: open
    })];
  });
  Zotero.GoogleDocs.UI.OrphanedCitationsList = function ({
    citations,
    open
  }) {
    function renderCitation(citation) {
      return React.createElement("li", {
        ...
        className: "zotero-orphaned-citation",
        href: "#",
        onClick: () => Zotero.GoogleDocs.UI.selectText(citation.text, citation.url)
      }, citation.text));
    }
    return React.createElement("div", {
      className: "zotero-orphaned-citations-popover docs-bubble",
      style: {
        position: "absolute",
        right: "-140px",
        top: "48px",
      ...
      className: "zotero-orphaned-citations-disclaimer",
      style: {
        whiteSpace: 'normal',
        fontSize: "1.2em",
        color: "#333",
      ...
      className: "zotero-orphaned-citations-list",
      style: {
        listStyle: "none",
        marginBottom: ".4em",
        padding: "0"
