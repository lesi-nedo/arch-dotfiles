...
Zotero.Inject = {
  ...
  async firstUsePrompt() {
    ...
    return this.confirm({
      ...
      button2Text: "",
      message: Zotero.getString('firstRun_text1', [clientName, "https://www.zotero.org/support/adding_items_to_zotero"]) + '<br><br>' + Zotero.getString('firstRun_text2', [clientName,
