      ...
      ScrollView {
        ...
        Column {
          ...
          Column {
            ...
            Repeater {
              model: BluetoothService.pairedDevices.length > 0 ? BluetoothService.sortDevices(BluetoothService.pairedDevices) : []
            ...
            Repeater {
              model: {
                ...
                var filtered = Bluetooth.devices.values.filter(dev => {
                                                                return dev && !dev.paired && !dev.pairing && !dev.blocked && !dev.trusted
